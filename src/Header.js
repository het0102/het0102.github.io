    ...
    return(
    	...
    	<nav className={navbar ? 'navbar active navbar-expand-lg navbar-light' : 'navbar navbar-expand-lg navbar-light'}>
		  <div class="container-fluid">
		  	...
		  	<a class="navbar-brand mt-0 pt-0 px-4" onClick={() => scroll.scrollToTop()} style={{cursor:"pointer"}}><img src="/img/logo6.png" style={{width:"100%",height:"auto",maxHeight:"100px", maxWidth:"150px"}} alt="logo" /></a>
