...
const Statistics = () => {
  ...
  const awards = [
    { title: "Achiever of the Quarter", organization: "Commerce Pundit Technologies", year: "2025" },
    { title: "Rising Star Award", organization: "Commerce Pundit Technologies", year: "2024" },
    { title: "Star Performer of the Month", organization: "Commerce Pundit Technologies", year: "2023" },
    { title: "Star Performer of the Month", organization: "Commerce Pundit Technologies", year: "2022" }
  ];
          ...
          <div key={idx} className="col-lg-3 col-md-6">
            <Fade bottom delay={idx * 120}>
              <div className="glass-panel p-4 text-center h-100 d-flex flex-column justify-content-center align-items-center">
                ...
                <h4 style={{ fontSize: "16px", fontWeight: "700", marginBottom: "8px", fontFamily: "var(--font-orbitron)" }}>
                  {award.title}
                </h4>
                <p style={{ fontSize: "13px", color: "var(--text-secondary)", marginBottom: "4px" }}>
                  {award.organization}
                </p>
                <span style={{ fontSize: "12px", color: "var(--color-cyan)", fontWeight: "600" }}>
                  {award.year}
                </span>
              </div>
            </Fade>
