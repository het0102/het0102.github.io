	...
	return(
		...
		<div className="container-fluid">
			...
			<div className="row skill d-flex justify-content-center">
                <br/><br/>
				<h1 className="text-center my-5 text-white"><strong>Technical Skills</strong></h1>
				...
				<div className="col-md-4 mb-5 d-grid justify-content-center">
					...
					<div class="card">
					  ...
					  <div class="card-body">
					    ...
					    <h2 class="card-title text-center"><b>Frontend</b></h2>
					    <hr/>
				...
				<div className="col-md-4 mb-5 d-grid justify-content-center">
					...
					<div class="card">
					  ...
					  <div class="card-body">
					    ...
					    <h2 class="card-title text-center"><b>Backend</b></h2>
					    <hr/>
                        ...
                        <hr/>
                        <h2 class="card-title text-center"><b>Database</b></h2>
					    <hr/>
                        ...
                        <hr/>
                        <h2 class="card-title text-center"><b>Other Skills</b></h2>
					    <hr/>
				...
				<div className="col-md-4 mb-5 d-grid justify-content-center">
					...
					<div class="card">
					  ...
					  <div class="card-body">
					    ...
					    <h2 class="card-title text-center"><b>Programming Languages</b></h2>
					    <hr/>
                        ...
                        <hr/>
                        <h2 class="card-title text-center"><b>Hosting Platform</b></h2>
					    <hr/>
                        ...
                        <hr/>
                        <h2 class="card-title text-center"><b>Version Control</b></h2>
					    <hr/>
