				...
				<div class="container">
				  <div class="row d-flex align-items-center justify-content-center">
				    <div class="col-lg-5 col-xs-12 d-grid align-items-center justify-content-center">
				      ...
				      <p class="text-white footer-content">There are three responses to a piece of design — yes, no, and WOW! Wow is the one to aim for. </p> 
				    </div>
				    <div class="col-lg-3 col-xs-12 d-flex justify-content-center align-items-center">
				      <div onClick={() => scroll.scrollToTop()} style={{cursor:"pointer"}}><img src="./img/logo4.png" style={{width:"100%",maxHeight:"200px", maxWidth:"250px"}} alt="logo" /></div>
				    </div>
