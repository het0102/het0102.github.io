			...
			<div className="row">
				...
				<div class="about-me-content mt-3">
					<ul>
						...
						<li><p className="content-about">I have been <span style={{borderBottom:"2px solid #870BE8"}}>designing for the web for quite a while</span>, but that doesn't matter much now everything is changing!</p></li>
