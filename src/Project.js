...
const Project = () => {
  ...
  return (
  			...
  			<div className="container-fluid skill">
  				...
  				<br/>
  				<h1 className="pt-3 text-center my-5 text-white"><strong>Projects</strong></h1>

  					<div className="col-md-4 d-flex justify-content-center mb-5">
  						<div class="card">
						  <img src="./img/reactjsimg2.png" class="card-img-top image" alt="image" style={mystyle} />
						  <div class="card-body">
						    <h5 class="card-title text-center my-3"><h3><b>Pruthatek.app</b></h3></h5>
						    <p class="card-text" style={mystyle2}><strong>Description :</strong>&nbsp;Convert your website to an app with just your URL in less than 24 hours.</p>
  					...
  					<div className="col-md-4 d-flex justify-content-center mb-5">
  						<div class="card">
						  <img src="./img/reactjsimg3.png" class="card-img-top image" alt="image" style={mystyle} />
						  <div class="card-body">
						    <h5 class="card-title text-center my-3"><h3><b>The tiger.live</b></h3></h5>
						    <p class="card-text" style={mystyle2}><strong>Description :</strong>&nbsp;It is a price recommendation tool for amazon products, that can track prices of products.</p>
  					...
  					<div className="col-md-4 d-flex justify-content-center mb-5">
  						<div class="card">
						  <img src="./img/reactjsimg.png" class="card-img-top image" alt="image" style={mystyle} />
						  <div class="card-body">
